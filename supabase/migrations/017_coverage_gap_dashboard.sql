-- 017_coverage_gap_dashboard.sql
-- Phase 7 coverage tracking: dashboard-friendly rollups for grade/subject/standard coverage.
...
with base_modules as (
  ...
  where m.grade_band in ('3', '4', '5', '6', '7', '8')
    and m.subject in ('Mathematics', 'English Language Arts', 'Science', 'Social Studies')
),
lesson_counts as (
  select
    module_id,
