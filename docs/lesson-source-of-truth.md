...
- do not treat it as the universal template for every subject and grade
...
6. Use the exemplar lesson for concrete modeling
7. Use the audit and rewrite pipeline docs for operational flow
8. Use execution plans and scripts for rollout
