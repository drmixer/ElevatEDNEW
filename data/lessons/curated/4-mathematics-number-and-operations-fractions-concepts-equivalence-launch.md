...
## Worked Example
One tray shows 4/7 shaded and another shows an equivalent model with twice as many parts.
...
<!-- generated_by: harden_grades_3_5_curriculum.ts; source_slug: 4-mathematics-number-and-operations-fractions-concepts-equivalence; standards: 4.NF.A.1 -->
